...
const SideBar = () => {
  return (
    <div className="hidden  border border-gray-300 sm:flex flex-col justify-start space-y-5 px-2 max-h-screen">
      ...
      <div>
        <input type='text' placeholder='Search..' className='border border-gray-300 rounded-3xl font-semibold px-3 py-1' />
      </div>
      ...
      <div className='flex gap-2 '>
            <img src={tasks} />
            <h1 className='font-plus font-medium'>Tasks</h1>
        </div>
         <div className='flex gap-2'>
            <img src={users} />
            <h1 className='font-plus font-medium'>Users</h1>
        </div>
      <div className='flex gap-2 '>
            <img src={cube} />
